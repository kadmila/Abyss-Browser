...
extern __declspec(dllexport) int Event_PeerConnected_Query(uintptr_t h_event, char* peer_id_buf_ptr, int peer_id_buf_len);
extern __declspec(dllexport) int Event_PeerDisconnected_Query(uintptr_t h_event, char* peer_id_buf_ptr, int peer_id_buf_len);
extern __declspec(dllexport) int Event_PeerFound_Query(uintptr_t h_event, char* peer_id_buf_ptr, int peer_id_buf_len);
extern __declspec(dllexport) int Event_PeerForgot_Query(uintptr_t h_event, char* peer_id_buf_ptr, int peer_id_buf_len);
...
extern __declspec(dllexport) void CloseAbystClient(uintptr_t h);
extern __declspec(dllexport) uintptr_t Host_NewCollocatedHttp3Client(uintptr_t h);
extern __declspec(dllexport) void CloseCollocatedHttp3Client(uintptr_t h);
