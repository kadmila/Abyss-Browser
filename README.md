...
1) Run ./project_init.ps1
2) Open Unity hub. Add > Add project from disk > select ./AbyssUnity folder.
3) Open the unity project. This takes minutes to complete.
4) When unity project opens without failing (no window asking for entering safe mode), open "Main" from Scene.
5) Enter play mode.
